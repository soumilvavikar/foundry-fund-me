...
# Shortcut for sepolia test deployment on local anvil
deploy-sepolia: 
	@echo "Deploying..."
	forge script script/DeployFundMe.s.sol --rpc-url $(SEPOLIA_RPC_URL) --private-key $(METAMASK_ACCT1_PRIVATE_KEY) --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv

# Add a help target for documentation
help:
	@echo "Usage:"
